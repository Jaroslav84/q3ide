...
#define Q3IDE_LOS_PROXIMITY_MULT 2.0f   /* skip LOS when player is within this × window diagonal */
...
#define Q3IDE_WALL_DIST        512.0f  /* world units — wall-scan trace length */
#define Q3IDE_WALL_OFFSET      3.0f    /* world units — push off wall surface to avoid z-fighting */
...
#define Q3IDE_IDEAL_WINDOW_SIZE 100   /* world units diagonal — ideal window size */
#define Q3IDE_MIN_WINDOW_SIZE   66    /* world units diagonal — absolute floor */
#define Q3IDE_MAX_WINDOW_SIZE   200   /* world units diagonal — ceiling (matches spawn size) */
...
#define Q3IDE_OVL_CHAR_W      0.14f /* world units — bigchars character width */
...
#define Q3IDE_OVL_KB_RIGHT_MARGIN_PX    10  /* px — gap from right screen edge to keyboard right edge */
#define Q3IDE_OVL_KB_TOP_MARGIN_PX      100 /* px — gap from top to keyboard anchor (room for diagonal labels above) */
#define Q3IDE_OVL_WL_LEFT_MARGIN_PX     10  /* px — gap from left screen edge to window list */
#define Q3IDE_OVL_AREA_LABEL_TOP_PX     10  /* px — distance from screen top for area/room label */
